...
class TestKinesisLambdaWithDynamoDB(TestCase):
    ...
    def read_sam_template(self, sam_template_fn : str = "template.yaml" ) -> dict:
        ...
        """
        with open(sam_template_fn, "r") as file_pointer:
            template =file_pointer.read().replace("!","")   # Ignoring intrinsic tags
    ...
    def test_lambda_handler_happy_path(self):
        ...
        #check the mocked DynamoDB to see if PK matches to what we passed to the Kinesis Event
