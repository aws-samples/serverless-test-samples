...
public class Setup : IAsyncLifetime
{
    ...
    public async Task InitializeAsync()
    {
        ...
        this.SourceBucketName = GetOutputVariable(outputs, "SourceBucketName");
        this.DestinationTableName = GetOutputVariable(outputs, "AsyncTransformTestResultsTable");
        this.DynamoDbClient = new AmazonDynamoDBClient(new AmazonDynamoDBConfig() { RegionEndpoint = endpoint });
        this.S3Client = new AmazonS3Client(new AmazonS3Config() { RegionEndpoint = endpoint });
    }
